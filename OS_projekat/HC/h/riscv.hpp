...
#include "../lib/hw.h"
// implementacija citanja ili upisa u sistemske registre
class Riscv
{
public:


    //metoda koja vraca procesor u stanje pre prekidne rutine
    ...
    //procesor poziva kad se poziva zahtev za prekidom ili exception i ispunjeni su uslovi za njego hendler
    static void supervisorTrap();

private:
    //metoda koja obradjuje TRAP u okviru prekidne rutine
